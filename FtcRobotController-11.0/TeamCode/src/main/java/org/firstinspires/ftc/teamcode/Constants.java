...
public class Constants {
    ...
    public final static double ELEVATOR_SPEED = 1;
    public final static double DRIVE_SPEED = 1;
    public final static double TURRET_SPEED = 1;
    public final static double FLYWHEEL_SPEED_TWO = .72;
    public final static double FLYWHEEL_SPEED_ONE = .85;
    ...
    public final static String ELEVATOR_MOTOR = "elevator_motor"; // expansion port 3
    public final static String TURRET_MOTOR = "turret_motor"; // expansion port 1
    public final static String FLYWHEEL_MOTOR = "flywheel_motor";// expansion port 2
